                    ...
                    {!collapsed.rice && (
                        <>
                            ...
                            <div
                                ...
                                <span className="jira-rice-farm-board-issue-view-section-button-label">I = {issueData ?
                                    iValue.toFixed(0) : '0'}</span>
                                        ...
                                        {Object.entries(issueData.value!.impacts).map(([name, value]) => {
                                            ...
                                            return (
                                                <div key={name}
                                                    ...
                                                    {name} ({category?.names[value] || value} = {category?.values[value] || "?"})
                                                </div>
                                            );
                                        })}
                                    </div>
                            ...
                            <div
                                ...
                                <span
                                    className="jira-rice-farm-board-issue-view-section-button-label">C = {issueData && jiraBoardDataStore.jrfBoardData ?
                                    cValue.toFixed(0) : '0'}</span>
                            ...
                            <div
                                ...
                                <span
                                    className="jira-rice-farm-board-issue-view-section-button-label">E = {issueData ? eValue.toFixed(0) : '0'}</span>

                                {!collapsed.e && issueData && (
                                    <div className="jira-rice-farm-board-issue-view-subsection">
                                        <div className="jira-rice-farm-board-issue-view-subsection-item">
                                            {jiraBoardDataStore.jrfBoardData?.effortDescription || ''}
                                        </div>
                                    </div>
                                )}
                            </div>
